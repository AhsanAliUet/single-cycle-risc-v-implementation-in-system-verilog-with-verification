...
riscv64-unknown-elf-gcc -o build/asm_code.elf build/asm_code.o -T linker.ld -nostdlib -march=rv32i -mabi=ilp32
...
copy "build\asm_code.txt" "../../sim/machine_codes.txt"